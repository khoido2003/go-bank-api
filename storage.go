...
// Without using docker volume to store data
...
// use docer volume to store data
// docker run --name my-postgres-container \
//   -e POSTGRES_PASSWORD=mysecretpassword \
//   -e POSTGRES_DB=mycustomdatabase \
//   -p 5432:5432 \
...
func NewPostgresStore() (*PostgresStore, error) {
	...
	connStr := "user=postgres dbname=postgres password=khoizpro7  sslmode=disable"
...
func (s *PostgresStore) CreateAccount(acc *Account) error {
	...
	($1, $2, $3, $4, $5, $6)
	`
	resp, err := s.db.Query(query, acc.FirstName, acc.LastName, acc.Number, acc.Balance, acc.CreatedAt, acc.EncryptedPassword)
